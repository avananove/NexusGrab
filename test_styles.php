...
<head>
    ...
    <title>Test Stili - NexusGrab</title>
...
<body>
    ...
    <div class="container mt-4">
        <h1>Test Stili NexusGrab</h1>
        
        <div class="debug-info">
            <strong>Debug Info:</strong><br>
            - CSS caricato: assets/css/style.css<br>
            - Bootstrap: 5.3.0<br>
            - FontAwesome: 6.0.0<br>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Test Colori CSS Variables</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                <div style="background: var(--primary-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Primary
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div style="background: var(--secondary-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Secondary
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div style="background: var(--warning-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Warning
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div style="background: var(--success-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Success
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div style="background: var(--danger-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Danger
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div style="background: var(--info-color); color: white; padding: 10px; text-align: center; border-radius: 5px;">
                                    Info
                                </div>
                            </div>
                        </div>
